        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 max-h-[300px] overflow-y-auto pr-2 custom-scrollbar">
          {LANGUAGES.map((l) => (
            <div
              ...
              className={`group relative p-4 rounded-lg border-2 cursor-pointer transition-all flex items-center justify-between overflow-hidden ${
            ...
            >
              <div className="relative z-10 flex items-center gap-3">
                <span className="text-sm font-bold px-2 py-1 rounded bg-background border border-border text-muted-foreground uppercase group-hover:border-primary/30 transition-colors">
                  {l}
                </span>
