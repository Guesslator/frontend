    ...
    >
      <nav
        className={cn(
          ...
          isScrolled
            ? "max-w-[95%] md:max-w-7xl mx-auto rounded-full py-2.5 px-4 md:px-6 shadow-lg shadow-black/[0.03]"
            : "max-w-full rounded-none py-4 px-5 md:px-12 shadow-sm border-b border-white/5",
        )}
      >
        ...
        <div className="relative z-10 flex justify-between items-center">
          ...
          >
            <span
              className={cn(
                "text-xl md:text-3xl font-black tracking-tighter transition-all duration-300",
          ...
          <div className="flex gap-1.5 md:gap-4 items-center">
            <Link
              ...
              className={cn(
                ...
                "px-2.5 md:px-4 h-8 md:h-10 flex items-center gap-2",
              )}
            >
